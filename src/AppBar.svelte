...
<svg width="100%" height="30" x="0" y="0">
    ...
    <text font-weight="bold" x="10" y="15" fill="white" dominant-baseline="central" text-anchor="left">
        twitch.tv/danirod_
    </text>
    <text class="clock" font-weight="bold" x="50%" y="15" fill="white" dominant-baseline="central" text-anchor="middle">
        {timer}
    </text>
    <g class="symbolics">
